...
public class ContentProviderSettingAPIImpl extends SettingAPI {
    ...
    public boolean setBootsource(Source source) {
        ...
        try {
            mContentResolver.update(Uri.parse(SkyTvCommand.URI_PATH_SETTING_BOOT_SOURCE), contentValues, null, null);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public Source getBootsource() {
        ...
        Cursor cursor = null;
        try {
            cursor = mContentResolver.query(Uri.parse(SkyTvCommand.URI_PATH_SETTING_BOOT_SOURCE), SkyTvCommand.ATTRIBUTE_BOOT_SOURCE, null, null, null);
        } catch (Exception e) {
            e.printStackTrace();
        }
        if (cursor == null) {
    ...
    public List<Source> getBootsourceList() {
        ...
        Cursor cursor = null;
        try {
            cursor = mContentResolver.query(Uri.parse(SkyTvCommand.URI_PATH_SETTING_SOURCE_LIST), SkyTvCommand.ATTRIBUTE_BOOT_SOURCE, null, null, null);
        } catch (Exception e) {
            e.printStackTrace();
        }
        if (cursor == null) {
