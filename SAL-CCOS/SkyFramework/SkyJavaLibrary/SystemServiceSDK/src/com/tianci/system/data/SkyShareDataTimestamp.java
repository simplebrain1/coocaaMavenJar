...
public class SkyShareDataTimestamp {
    ...
    public static void setSharedValue(Context context, String name, String value){
        try
        {
            if(value == null)
                return;
            SharedPreferences pwdPrefs = context.getSharedPreferences("system_datats",
    ...
    public static String getSharedValue(Context context,String name){
        try
        {
            SharedPreferences pwdPrefs = context.getSharedPreferences("system_datats", 0);
    ...
    public static int getIntSharedValue(Context context,String name)
    {
        try
        {
            SharedPreferences pwdPrefs = context.getSharedPreferences("system_datats", Context.MODE_PRIVATE);
    ...
    public static String getFactoryShareValue(Context context,String name)
    {

        try
        {
            Context ctx = context.createPackageContext("com.skyworth.tvos.factory", Context.MODE_MULTI_PROCESS);
            SharedPreferences sp = ctx.getSharedPreferences("factory_data", Context.MODE_MULTI_PROCESS);
