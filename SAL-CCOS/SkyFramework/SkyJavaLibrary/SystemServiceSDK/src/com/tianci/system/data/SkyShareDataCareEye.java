...
public class SkyShareDataCareEye {
    ...
    public static void setSharedValue(Context context, String name, String value){
        try
        {
            if(value == null)
                return;
            SharedPreferences pwdPrefs = context.getSharedPreferences("system_datacy",
    ...
    public static String getSharedValue(Context context,String name){
        try
        {
            SharedPreferences pwdPrefs = context.getSharedPreferences("system_datacy", 0);
    ...
    public static int getIntSharedValue(Context context,String name)
    {
        try
        {
            SharedPreferences pwdPrefs = context.getSharedPreferences("system_datacy", Context.MODE_PRIVATE);
