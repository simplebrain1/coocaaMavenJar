...
public class SkyShareData
{
    ...
    public static void setSharedValue(Context context,String name, String value){
        try
        {
            if(value == null)
                return;
            SharedPreferences pwdPrefs = context.getSharedPreferences("system_data",
    ...
    public static String getSharedValue(Context context,String name){
        try
        {
            SharedPreferences pwdPrefs = context.getSharedPreferences("system_data", 0);
    ...
    public static int getIntSharedValue(Context context,String name)
    {
        try
        {
            SharedPreferences pwdPrefs = context.getSharedPreferences("system_data", Context.MODE_PRIVATE);
