package com.skyworth.framework.virtualinput;
...
public class SkyworthKeyMap {
    public enum SkyworthKey {
        /*
         * 普通遥控键值 待机; 1; 2; 3; 4; 5; 6; 7; 8; 9; 0; 3D\<-; 交替; 频道+; 频道-; 音量+; 音量-; 静音; 信号源; 确定;
         * 语音[长按确定键]; 上; 下; 左; 右; 返回; 菜单; 主页; 云分享; 导视; "红\电视广播"; "绿\声道"; "黄\信息"; "蓝\点播"; 图像模式; 声音模式;
         * 显示模式; 屏显; 上一首; 下一首; 快退; 快进; 播放|暂停; 停止; 点歌系统; 关联; 预约; 喜爱; 音效控制; 功能; 原声; 录音; 已点歌曲; 优先; 删除;
         * 评分显示; 数位键; 长按主页；长按返回；长按菜单；
         */
        SKY_KEY_POWER,
        SKY_KEY_1,
        SKY_KEY_2,
        ...
        /*
         * 工厂遥控键值 工厂调试键; 调测恢复键; 通道+; 通道-; 退出工厂模式键; 总线键 老化模式键; ADC校正键; 视频1通道键; RF-AGC键; 视频2通道键
         * 视频3通道键; S视频1通道键; 分量1通道键; 分量2通道键; VGA通道键 HDMI1通道键; HDMI2通道键; HDMI3通道键; 酷k调测键; Uplayer调测键
         * 网络调测键; 屏变调测键; 白平衡调整键; 单独听调测键; CA卡信息键 电子码; 向上搜台; 向下搜台
         */
        ...
        /*
         * 键控板感应键值 靠近键控板感应; 靠近键控板菜单键感应; 靠近键控板确定键感应 靠近键控板返回键感应; 靠近键控板音量加感应; 靠近键控板音量减感应 靠近键控板频道加感应;
         * 靠近键控板频道减感应; 离开键控板感应
         */
        SKY_KEY_SENSE_ALL,
        SKY_KEY_SENSE_MENU,
        ...
        SKY_KEY_SENSE_LEAVE,
        /*
         * 自定义虚拟键值 鼠标左键；鼠标中键；鼠标右键; 图片放大; 图片缩小
         */
        SKY_KEY_MOUSE_OK,
        ...
        SKY_KEY_COOCAA;
        //
        // 0x1f2, //SKY_KEY_CENTER_LONG
        // 0x2d9, //SKY_KEY_SHUTTLE_LEFT_SPEED_6
        // 0x1a, //SKY_KEY_NEW_SHUTTLE_LEFT
        // 0x2df, //SKY_KEY_SHUTTLE_RIGHT_SPEED_6
        // 0x1b, //SKY_KEY_NEW_SHUTTLE_RIGHT
        // 0x1f1, //SKY_KEY_SEEK_SIGNAL
    ...
    /**
     * 对应老的SkyworthSDK里面的键值，SKY_KEY_POWER在老的SkyworthSDK的SkyworthKey里面，对应位置是0；SKY_KEY_1对应5；这里面有的键值，
     * 老的里面没有的话，直接 对应-1
     */
